...
type rootFlags struct {
	...
	yes        bool
	agent      bool
	playerName string // --name: character name for daemon connection
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "dp-goat-pp-cli",
		Short: "Manage dp-goat resources via the dp-goat API",
		Long: `Manage dp-goat resources via the dp-goat API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'dp-goat-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("dp-goat-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.playerName, "name", "", "Character name (connects to dp-goat daemon over Unix socket)")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'dp-goat-pp-cli profile list')")
	...
	rootCmd.AddCommand(newExploreCmd(flags))
	rootCmd.AddCommand(newImportCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newCastPromotedCmd(flags))
	rootCmd.AddCommand(newConsiderPromotedCmd(flags))
	rootCmd.AddCommand(newDownPromotedCmd(flags))
	rootCmd.AddCommand(newDrinkPromotedCmd(flags))
	rootCmd.AddCommand(newDropPromotedCmd(flags))
	rootCmd.AddCommand(newEastPromotedCmd(flags))
	rootCmd.AddCommand(newEatPromotedCmd(flags))
	rootCmd.AddCommand(newFleePromotedCmd(flags))
	rootCmd.AddCommand(newGetPromotedCmd(flags))
	rootCmd.AddCommand(newGivePromotedCmd(flags))
	rootCmd.AddCommand(newInventoryPromotedCmd(flags))
	rootCmd.AddCommand(newKillPromotedCmd(flags))
	rootCmd.AddCommand(newLookPromotedCmd(flags))
	rootCmd.AddCommand(newNorthPromotedCmd(flags))
	rootCmd.AddCommand(newSayPromotedCmd(flags))
	rootCmd.AddCommand(newScorePromotedCmd(flags))
	rootCmd.AddCommand(newSouthPromotedCmd(flags))
	rootCmd.AddCommand(newTellPromotedCmd(flags))
	rootCmd.AddCommand(newUpPromotedCmd(flags))
	rootCmd.AddCommand(newWearPromotedCmd(flags))
	rootCmd.AddCommand(newWestPromotedCmd(flags))
	rootCmd.AddCommand(newWhoPromotedCmd(flags))
	rootCmd.AddCommand(newWieldPromotedCmd(flags))
	rootCmd.AddCommand(newYellPromotedCmd(flags))
...
func (f *rootFlags) newClient() (client.Transport, error) {
	// If --name is set, use the daemon socket client instead of HTTP
	if f.playerName != "" {
		return client.NewDaemonClient(f.playerName, f.timeout), nil
	}
