...
but do not stop the import.`,
  ...
  dp-goat-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  dp-goat-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | dp-goat-pp-cli import <resource> --input -`,
