# Dp Goat Printed CLI Agent Guide

This directory is a generated `dp-goat-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
dp-goat-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
dp-goat-pp-cli which "<capability>" --json
dp-goat-pp-cli <command> --help
```
...
```bash
dp-goat-pp-cli <command> --help
dp-goat-pp-cli <command> --dry-run --agent
```
