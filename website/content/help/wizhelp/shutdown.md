...
[SHUTDOWN](/help/wizhelp/shutdown/) shuts the MUD down.  The [SHUTDOWN](/help/wizhelp/shutdown/) command works in conjunction with
...
[DIE](/help/info/die-death-condie/)        Kill the autorun script; the MUD will not reboot until autorun is
