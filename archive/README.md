...
These documents preserve earlier plans and handoffs. They are not current
operating instructions or an open task queue.

- [June 17 Zachlog](ZACHLOG-2026-06-17.md): original handoff, with a correction
...
Use [Running Dark Pawns](../DEPLOYMENT.md) and the
[documentation index](../docs/README.md) for current entry points.
