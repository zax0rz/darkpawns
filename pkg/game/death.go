...
func (w *World) handleMobDeath(victim combat.Combatant, killer combat.Combatant, attackType int) {
	...
	if attackType != 191 && attackType != SkillCutthroatNum && attackType != SkillDisembowelNum {
...
// Go encoding: 0=male, 1=female, 2=neutral. The default (including unknown
// values) maps to male ("his").
