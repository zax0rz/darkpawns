...
// ClassSpells maps each class to the set of spells/skills it can learn and at
// what level. Indexed by Class constant (ClassMageUser=0 .. ClassMystic=11).
// Faithfully translated from src/class.c:init_spell_levels() — C is authoritative.
//
