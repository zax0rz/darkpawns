...
var positionCommandSpecs = [...]positionCommandSpec{
	{
		...
		arms: [combat.PosStanding + 1]positionCommandArm{
			...
			combat.PosSitting:  {self: "You stand up.", room: "$n clambers to $s feet.", hideRoom: true},
			combat.PosResting:  {self: "You stop resting, and stand up.", room: "$n stops resting, and clambers on $s feet.", hideRoom: true},
	...
	},
	{
		...
		arms: [combat.PosStanding + 1]positionCommandArm{
			combat.PosStanding: {self: "You sit down.", room: "$n sits down."},
			combat.PosSitting:  {self: "You're sitting already."},
			combat.PosResting:  {self: "You stop resting, and sit up.", room: "$n stops resting.", hideRoom: true},
			combat.PosSleeping: {self: "You have to wake up first."},
	...
	},
	{
		...
		mountedMessage: "You can't rest while mounted.",
		arms: [combat.PosStanding + 1]positionCommandArm{
			combat.PosStanding: {self: "You sit down and rest your tired bones.", room: "$n sits down and rests.", hideRoom: true},
			combat.PosSitting:  {self: "You rest your tired bones.", room: "$n rests.", hideRoom: true},
	...
	},
	{
		...
		mountedMessage: "You can't rest while mounted.",
		arms: [combat.PosStanding + 1]positionCommandArm{
			combat.PosStanding: {self: "You go to sleep.", room: "$n lies down and falls asleep.", hideRoom: true},
			combat.PosSitting:  {self: "You go to sleep.", room: "$n lies down and falls asleep.", hideRoom: true},
			combat.PosResting:  {self: "You go to sleep.", room: "$n lies down and falls asleep.", hideRoom: true},
