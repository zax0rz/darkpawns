-- Source: scripts_full_dump.txt ./mob/archive/cuchi.lua
-- cuchi.lua — oncmd interaction for Oro's pet mob. Patting gives level boost to Orodreth
-- or 10 gold to anyone else.
