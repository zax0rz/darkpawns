-- Source: scripts_full_dump.txt ./mob/archive/rescuer.lua
-- rescuer.lua — onpulse_pc that rescues the first fighting mob (being attacked by a player)
-- it finds in the room. Attached to mob 7909.
