-- baker_flour.lua
-- Source: scripts_full_dump.txt ./mob/archive/baker_flour.lua
-- Baker in Kir Drax'in. Accepts flour (obj 15100) → dough (obj 8015) → bread (obj 8010).
-- Also accepts dough directly to bake bread for 1 gold.
