-- golem_from_crate.lua
-- Source: scripts_full_dump.txt ./mob/archive/golem_from_crate.lua
-- Transport golem (mob 11706). Retrieves crystalline chunks (obj 11701) from wooden
-- crates (obj 11702) and deposits them into a bucket at the mine entrance (room 11708).
