-- Source: scripts_full_dump.txt ./mob/archive/guard_captain.lua
-- guard_captain.lua — onpulse_pc that wakes sleeping guards from a list of vnums and
-- exchanges flavour emotes with citizens.
