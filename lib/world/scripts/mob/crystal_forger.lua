-- crystal_forger.lua
-- Source: scripts_full_dump.txt ./mob/archive/crystal_forger.lua
-- The crystal forger (mob 7923) accepts crystalline chunks (obj 11701) and converts
-- them into crystal armor/gloves depending on the number of chunks and player gold.
-- Items: gloves (11706, 1 chunk, 200g), leggings (11707, 3 chunks, 500g),
--        sleeves (11708, 3 chunks, 500g), breastplate (11709, 5 chunks, 1000g)
