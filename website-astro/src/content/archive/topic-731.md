...
captureUrl: "https://web.archive.org/web/20040724090156/http://www.dp-players.com:80/forum/viewtopic.php?p=731&amp"
...
*Transcript note: generated from the raw phpBB capture `dp-players-thread-p731-20040724090156.html`. Author sidebars, profile links and private-message links are omitted.*
...
### Vargus — Fri Jul 02, 2004 1:10 am
...
### Fred Sanford — Fri Jul 02, 2004 6:00 am
...
### Vargus — Sat Jul 03, 2004 5:59 am
...
### Fred Sanford — Sat Jul 03, 2004 9:25 am
...
### Frontline — Sun Jul 04, 2004 11:39 am
...
### Ragnorok — Wed Jul 07, 2004 1:04 pm
...
### Whistler — Wed Jul 07, 2004 5:10 pm
...
> **Ragnorok, earlier in this thread:**
>
> The point Im making is that small changes may bring some back for a while... but you're going to need a BIG change to resurrect this place
...
### Morpheus — Sat Jul 10, 2004 10:13 am

i believe they did ptest it with a select few players.

*boxing*

### Doragar — Tue Jul 13, 2004 3:57 am

> **Whistler, earlier in this thread:**
>
> As I understand it (FL, please correct me if I am mistaken), the 3.0 version is incompatible in certain important ways with the current version, making any import of small changes (i.e., adding a new zone, etc) essentially impossible.
...
> **Mar, earlier in this thread:**
>
> Take what you have for 3.0 assuming its semi playable and open a test server up so we can jump on and help try things out, find bugs, and add usefull suggestions. BETA TEST for god sakes.

Beta testing is certainly on the cards and while I do my best to iron out bugs during code production, the only people that can reliably do it are the players who seem to find an infinite number of ways to beat the system. Having said that, there is still a core component of code in development and while you can safely play 3.0 today, I'd prefer if it were finished before letting you loose.

> **Mar, earlier in this thread:**
>
> I'll also say this again. FL, give the mud to someone who has the time to deal with it.
...
### Mar — Tue Jul 13, 2004 12:28 pm

You make a good point.

### Frontline — Wed Jul 14, 2004 3:26 pm
...
### Fred Sanford — Sat Jul 17, 2004 2:09 am

On a pretty much unrelated note, check out this ridiculously overdescribed, yet badass dude: (Don't ask where he's from \[Razz\] )
 ...
 loads: the Shroud of Death item is: about body MAGIC !good !neutral con - 5 cha - 3 damroll 2 Mana\_Regen by 8 !ranger !paladin !warrior !ninja !assassin !thief !psionic\
 Loads: 9%\
