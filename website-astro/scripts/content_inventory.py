...
Review technical documentation for accuracy and audience fit. Review each dynamic collection template and each generated index template once, with representative desktop and mobile pages.
...
def main() -> None:
    ...
    public = sorted(content_entries() + structural_entries(), key=lambda entry: entry.route)
