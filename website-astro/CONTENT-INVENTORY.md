...
- **26356 built public routes**
- **492 compatibility redirects**
- **142,654 words in Markdown bodies**
- **429 fidelity-protected help entries**
- **37 recovered community artifacts**
- **25890 authored, generated-index, or interactive routes**
...
| Blog posts | 5 | Full source, purpose, and voice review. |
...
| Agent Markdown records | 490 | Verify the shared frontmatter, canonical links, and representative output. |

## Review queue

### Tier 1: identity and trust (20 routes)
...
### Tier 3: documentation and templates (25860 routes)
