...
- **26345 built public routes**
- **486 compatibility redirects**
- **140,984 words in Markdown bodies**
- **429 fidelity-protected help entries**
- **37 recovered community artifacts**
- **25879 authored, generated-index, or interactive routes**
...
| Technical docs | 4 | Verify against the repository and intended audience. |
...
| Generated section indexes | 8 | Review the shared templates once, then inspect representative output. |
...
| Agent Markdown records | 485 | Verify the shared frontmatter, canonical links, and representative output. |
...
### Tier 3: documentation and templates (25849 routes)
