...
- **6933 built public routes**
- **494 compatibility redirects**
- **98,480 words in Markdown bodies**
- **429 fidelity-protected help entries**
- **9 recovered community artifacts**
- **6495 authored, generated-index, or interactive routes**
...
| Agent JSON records | 2991 | Verify the shared schema, provenance fields, links, and representative output. |
...
### Tier 3: documentation and templates (6467 routes)
