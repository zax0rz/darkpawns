...
Added `cmd/dp-oracle-diff/scenarios/taunt-depth.txt` with the standard actor,
...
slots; and `docs/fidelity/depth/taunt.tsv` with twelve durable unit,
...
The final `taunt-depth` matrix used the C oracle at seeds 1, 2, 3, 5, and 8.
...
- `make fidelity-depth` — 4,490 total, 4,385 proven/delegated, 54 blocked,
...
The handoff and evidence are in commits `4113a2885` and `90151f992` at the
...
frontier to 4,490 total, 4,385 proven/delegated, 54 blocked, and 51 excluded.
The next fresh social after this slice is `thank` at
