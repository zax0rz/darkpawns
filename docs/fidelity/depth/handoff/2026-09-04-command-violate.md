...
`violate-depth` oracle scenario using the standard actor, observer, target, and
generic-mob fixture. Exercise no argument, a visible player target with
...
twelve proven/delegated rows, bringing the frontier to 4,614 total, 4,509
