...
### Fix Status (2026-04-27)

| Status | Count | Percentage |
|--------|-------|------------|
| ✅ Fixed | 75 | 87% |
| 🔶 Deferred (structural) | 9 | 10% |
| ⬜ Open | 2 | 2% |
| **Total** | **86** | **100%** |

**Remaining open:** H-25 (JWT rotation); see individual items for status.
**Deferred:** C-02, C-03, H-01–H-06, M-23 (structural refactors).
...
### ~~M-23 🔶: Mob AI (`mobile_activity`) Not Fully Ported~~ (deferred — high effort structural)
**Source:** Pass 4 (M5)  
