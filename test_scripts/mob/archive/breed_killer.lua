-- Source: scripts_full_dump.txt ./mob/archive/breed_killer.lua
-- breed_killer.lua — fight trigger delegates to fighter.lua; onpulse_pc hunts players
-- who carry AFF_VAMPIRE or AFF_WEREWOLF and stakes them if the mob has a stake/spike.

function fight()
  dofile("scripts/mob/archive/fighter.lua")
  call(fight, ch, "x")
end
