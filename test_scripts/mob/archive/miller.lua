-- miller.lua
-- Source: scripts_full_dump.txt ./mob/archive/miller.lua
-- Miller on the plains of Dor-Sefrith. Accepts wheat (obj 5300) → produces a sack of
-- flour (obj 15100) in the room + rewards 30 gold.
