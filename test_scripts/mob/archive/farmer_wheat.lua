-- farmer_wheat.lua
-- Source: scripts_full_dump.txt ./mob/archive/farmer_wheat.lua
-- Wheat farmer (mob 5305) in Mist Keep. Periodically spawns wheat bundles (obj 5300)
-- in the room for players to pick up and trade at the mill.
