-- Source: scripts_full_dump.txt ./mob/archive/mount.lua
-- mount.lua — onpulse_all that returns the mount to the stables when its master is gone
-- or its timer has expired. Removes AFF_MOUNT from player and AFF_CHARM from mount on expiry.
