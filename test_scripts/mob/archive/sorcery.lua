-- sorcery.lua - Combat AI for sorcery mobs
-- Faithful port of original sorcery.lua from Dark Pawns MUD
-- Source: darkpawns/lib/scripts/mob/archive/sorcery.lua
-- Note: targets a random room occupant, not just current attacker
