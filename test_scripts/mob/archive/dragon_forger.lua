-- dragon_forger.lua
-- Source: scripts_full_dump.txt ./mob/archive/dragon_forger.lua
-- The dragon forger (mob 7917) accepts dragon scales (obj 10204) and converts them into
-- dragonscale armor. Also gives a business card (obj 7903) on first look.
-- Items: gloves (7906, 1 scale, 5000g), leggings (7907, 3 scales, 5000g),
--        sleeves (7908, 3 scales, 5000g), breastplate (7909, 5 scales, 9000g)
