-- Source: scripts_full_dump.txt ./mob/archive/guardian.lua
-- guardian.lua — onpulse_pc that charms/forces players to attack each other (or themselves
-- when alone). Attached to mob 1314.
