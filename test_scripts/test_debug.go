...
func (w *mockDebugWorld) GetPlayersInRoom(roomVNum int) []scripting.ScriptablePlayer {
	return nil
}

func (w *mockDebugWorld) GetObjPrototype(vnum int) scripting.ScriptableObject {
	return nil
}

func (w *mockDebugWorld) AddItemToRoom(obj scripting.ScriptableObject, roomVNum int) error {
	return nil
}

func (w *mockDebugWorld) HandleNonCombatDeath(player scripting.ScriptablePlayer) {
}
