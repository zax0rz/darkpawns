-- town_teleport.lua
-- Source: scripts_full_dump.txt ./mob/archive/town_teleport.lua
-- Town teleport mob. Allows rapid transport between the major cities of the realm
-- for a gold fee. Destinations: Kir Drax'in, Kir Morthis, Kir Oshi, Xixieqi, Mist Keep.
