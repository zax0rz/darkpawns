-- golem_miner.lua
-- Source: scripts_full_dump.txt ./mob/archive/golem_miner.lua
-- Mining golem (mob 11702). Periodically mines crystalline chunks (obj 11701) from
-- the tunnel wall and gives them to a transport golem (mob 11700) when one passes by.
