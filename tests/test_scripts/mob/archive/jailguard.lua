-- Source: scripts_full_dump.txt ./mob/archive/jailguard.lua
-- jailguard.lua — bribe trigger requiring level^2 gold or refuses; sound emote shows
-- remaining jail time; onpulse_pc boots players whose jail time has expired.
