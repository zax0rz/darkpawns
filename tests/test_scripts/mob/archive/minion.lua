-- Source: scripts_full_dump.txt ./mob/archive/minion.lua
-- minion.lua — onpulse_all that destroys talisman items scavenged by the mob, and removes
-- the matching cylinder of light from its pillar room when the talisman is gone.
-- Attached to mob 1313.
