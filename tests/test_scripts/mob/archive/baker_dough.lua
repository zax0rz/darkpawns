-- baker_dough.lua
-- Source: scripts_full_dump.txt ./mob/archive/baker_dough.lua
-- Baker who accepts a roll of dough (obj 8015) and produces a loaf of bread (obj 8010).
-- Rewards player 20 gold on delivery.
