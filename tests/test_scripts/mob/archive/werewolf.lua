-- werewolf.lua - Combat AI: howl or bite with extra damage and movement drain
-- During battle, the mob has a chance of howling or biting the player and causing
-- greater damage. Attached to mob 5510.
-- Source: scripts_full_dump.txt ./mob/archive/werewolf.lua
-- TODO: requires echo() implementation for zone-wide sound broadcast
