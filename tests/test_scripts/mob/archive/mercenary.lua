-- Source: scripts_full_dump.txt ./mob/archive/mercenary.lua
-- mercenary.lua — bribe trigger: mob follows and assists player as charmed ally when given
-- 100*level gold. onpulse_all removes abandoned mercenaries outside their home zone (8000-8099).
