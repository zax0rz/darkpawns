-- Source: scripts_full_dump.txt ./mob/archive/triflower.lua
-- Attached to mob 20310. Carnivorous plant: sleeps players via pollen, burns with enzyme.

function onpulse_pc()
  -- If a player is in the room, the plant will attempt to sleep the player.
