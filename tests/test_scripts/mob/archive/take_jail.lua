-- Source: scripts_full_dump.txt ./mob/archive/take_jail.lua
-- Used by aversin, jailguard via dofile. Takes outlaw players to jail.
-- Normal (non-nightbreed) players are jailed; nightbreeds are fought normally.
