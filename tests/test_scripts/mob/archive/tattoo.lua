-- tattoo.lua
-- Source: scripts_full_dump.txt ./mob/archive/tattoo.lua
-- Tattoo artist mob. Uses MXP links for interactive conversation about tattoo materials,
-- designs and dyes. Uses create_event for delayed replies.
-- TODO: requires create_event implementation, use tell() as no-op stub
