...
| 3 | `act.informative.c` | 2,803 | `pkg/game/act_informative.go`<br>`pkg/game/look.go`<br>`pkg/game/help.go`<br>`pkg/session/act_informative.go`<br>`pkg/session/informative_cmds.go` | 1:N | HIGH | Info/look/help/score/equipment/inventory/examine commands. |
